...
class SidebarComponent extends Component {
	...
	render() {
		return(
		<div>
			<div className={ClassNames('spacer', {'expand': this.state.navExpand})} ></div>
			<div id="sidebar" className={ClassNames({'expand': this.state.navExpand})}>
					<div className='side-navs'>
						...
						<div className="s-nav">
							<NavLink to='/clients' activeClassName="active" className="s-btn">
						...
						<div className="s-nav">
							<NavLink to='/email' activeClassName="active" className="s-btn">
								<div className="btn-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
						...
						<div className="s-nav">
							<NavLink to='/pages' activeClassName="active" className="s-btn">
								<div className="btn-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
								...
								<div className="btn-label">Pages</div>
								<div className="btn-drop"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#fff" d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"/></svg></div>
							</NavLink>
